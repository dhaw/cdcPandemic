function f=pandemic1Dall2(params,xdata,plotComp,plotEpis,ydata)%(R0,phi1,phi2,tlag,seednum,tswitch,closureFactor,betacModifier)
%Changes for closure:
...
%%
n=1; nbar=4;
NNbar=[19169690;62121035;184015269;39570590]*.001;
NN=sum(NNbar);
NNrep=repmat(NN,4,1);
%{
NN=pop;
...
betac=betao;%Assume R0 fitted to Oct wave
%}
...
%if solvetype==2
    ...
    f=fall(xdata,:);
    %f=reshape(fall(xdata,:),4*length(xdata),1);
    %f=[tout,Y];
end
%%
