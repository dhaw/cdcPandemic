function f=plotScenarios(F,NNbar,numScen)
%numScen=1;
NN=sum(NNbar);
%{
fi=F{numScen};
...
f2=median(sum(F{numScen+1}(:,1:5,:),2),3)/NN*1e5;
f3=median(sum(F{numScen+2}(:,1:5,:),2),3)/NN*1e5;
f4=median(sum(F{numScen+3}(:,1:5,:),2),3)/NN*1e5;

f5=median(sum(F{numScen+4}(:,1:5,:),2),3)/NN*1e5;
f6=median(sum(F{numScen+5}(:,1:5,:),2),3)/NN*1e5;
f7=median(sum(F{numScen+6}(:,1:5,:),2),3)/NN*1e5;
f8=median(sum(F{numScen+7}(:,1:5,:),2),3)/NN*1e5;
lf=size(f1,1);
%}
fs=10; lw=2;
cmap=lines(8);
...
plot(1:lf,f5,'linewidth',lw,'color',cmap(5,:));
plot(1:lf,f6,'-','linewidth',lw,'col',cmap(6,:));
plot(1:lf,f7,'-','linewidth',lw,'col',cmap(7,:));
plot(1:lf,f8,'-','linewidth',lw,'col',cmap(8,:));
