function [f,g,z2]=subPandemicSimulationCOVID19(NNbar,params,xdata,plotComp,plotEpis,ydata,tswitch)%(R0,phi1,phi2,tlag,seednum,tswitch,closureFactor,betacModifier)
mcmc=1;
age2mats=0;
y0in=0; 
t0shift=0;
...
seednum=6;
%tswitch=243;
closureFactor=0.7931;%ca;% .5486;%ct .802;%us .6405;%mn .6405; %mn 0.7931;%ca
betacModifier=1;
adultsDown=1;
phi1=1;
phi2=0.0095;%ca .0345;%ct .0003;%us 2.7890e-05;%mn .026;%mn 0.0095;%ca
