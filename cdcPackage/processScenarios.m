...
for i=1:numScen
    ...
    for a=1:na+1
        ...
        Ibinned(end-8,2,a)=nanmean(pweek(:,a));
        Ibinned(end-7:end-1,2,a)=prctile(pweek(:,a),[50,2.5,5,25,75,95,97.5]);
    end
    ...
    filename=strcat('RL',sceno,scentype,'IMP.csv');%Change for 2009 HP RL
